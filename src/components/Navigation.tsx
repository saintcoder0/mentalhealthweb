...
export function Navigation({ activeSection, onSectionChange }: NavigationProps) {
  ...
  const { loading: dataLoading } = useWellness();
      ...
      <div className="fixed top-6 right-8 z-50 flex flex-col items-center space-y-6 w-14">
        ...
        {user ? (
          <div className="flex flex-col items-center space-y-2">
            <div className="fab group relative flex flex-col items-center justify-center w-full h-14 transition-all duration-500 ease-out hover:scale-110 active:scale-95"
              title={user.email}
            >
              ...
              <User className="h-6 w-6 text-primary-foreground drop-shadow-sm transition-all duration-300 group-hover:scale-110" />
            </div>
            <Button
              onClick={signOut}
              variant="ghost"
          ...
          <button
            ...
            title="Sign In"
          >
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-accent/20 to-primary/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <LogIn className="h-6 w-6 text-primary-foreground drop-shadow-sm transition-all duration-300 group-hover:scale-110" />
          </button>
        )}
